...
txdb <- makeTxDbFromGFF("./eonSpe/biomarker_anno/EVM.final.gene.gff3.3",format="gff3")
...
count.files = list.files("./htseq/", pattern="^J.*ES.*.count2")
...
write.table(rpkm.all, "./rpkm.eonSpe.Aaron20170412.ES.xls", quote=F, sep="\t", row.names=F, col.names=TRUE)
